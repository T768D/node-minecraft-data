...
declare const enum DamageTypeData_scaling {
    "never" = 0,
    "when_caused_by_living_non_player" = 1,
    "always" = 2,
}

declare const enum DamageTypeData_effects {
    "hurt" = 0,
    "thorns" = 1,
    "drowning" = 2,
    "burning" = 3,
...
declare const enum DamageTypeData_deathMessageType {
    "default" = 0,
    "fall_variants" = 1,
...
declare const enum entityMetadataEntry_type {
    ...
    "weathering_copper_golem_state" = 34,
    "vector3" = 35,
    "quaternion" = 36,
