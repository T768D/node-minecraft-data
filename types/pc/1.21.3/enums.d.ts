...
declare const enum Particle_type {
    ...
    "nautilus" = 70,
    "dolphin" = 71,
    "campfire_cosy_smoke" = 72,
    "campfire_signal_smoke" = 73,
    "dripping_honey" = 74,
    "falling_honey" = 75,
    "landing_honey" = 76,
    "falling_nectar" = 77,
    ...
    "crimson_spore" = 80,
    "warped_spore" = 81,
    "spore_blossom_air" = 82,
    "dripping_obsidian_tear" = 83,
    "falling_obsidian_tear" = 84,
    "landing_obsidian_tear" = 85,
    "reverse_portal" = 86,
    "white_ash" = 87,
    "small_flame" = 88,
    "snowflake" = 89,
    "dripping_dripstone_lava" = 90,
    "falling_dripstone_lava" = 91,
    "dripping_dripstone_water" = 92,
    "falling_dripstone_water" = 93,
    "glow_squid_ink" = 94,
    "glow" = 95,
    "wax_on" = 96,
    "wax_off" = 97,
    ...
    "egg_crack" = 101,
    "dust_plume" = 102,
    "trial_spawner_detected_player" = 103,
    "trial_spawner_detected_player_ominous" = 104,
    "vault_connection" = 105,
    "dust_pillar" = 106,
    "ominous_spawning" = 107,
    "raid_omen" = 108,
    "trial_omen" = 109,
    "block_crumble" = 110,
}
...
declare const enum packet_name_10 {
    ...
    "pong" = 0x29,
    "recipe_book" = 0x2a,
    "displayed_recipe" = 0x2b,
    "name_item" = 0x2c,
    "resource_pack_receive" = 0x2d,
    "advancement_tab" = 0x2e,
    "select_trade" = 0x2f,
    "set_beacon_effect" = 0x30,
    "held_item_slot" = 0x31,
    "update_command_block" = 0x32,
    "update_command_block_minecart" = 0x33,
    "set_creative_slot" = 0x34,
    "update_jigsaw_block" = 0x35,
    "update_structure_block" = 0x36,
    "update_sign" = 0x37,
    "arm_animation" = 0x38,
    "spectate" = 0x39,
    "block_place" = 0x3a,
