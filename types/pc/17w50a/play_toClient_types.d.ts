    ...
    extraNodeData: undefined | string  | 
{
    name: string;
    parser: string;
    properties: varint | i8 | bool | undefined  | 
{
    /**
     * This is a bitfield
     * Format: (name : bits a-b : signed)
