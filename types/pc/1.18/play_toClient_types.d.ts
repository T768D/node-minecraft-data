...
export interface packet_sculk_vibration_signal {
    sourcePosition: position;
    destinationIdentifier: string;
    destination: position | varint | undefined ;
    arrivalTicks: varint;
}
...
export interface packet {
    name: packet_name_7;
    params: packet_spawn_entity | packet_spawn_entity_experience_orb | packet_spawn_entity_living | packet_spawn_entity_painting | packet_named_entity_spawn | packet_animation | packet_statistics | packet_advancements | packet_block_break_animation | packet_tile_entity_data | packet_block_action | packet_block_change | packet_boss_bar | packet_difficulty | packet_tab_complete | packet_declare_commands | packet_face_player | packet_nbt_query_response | packet_chat | packet_multi_block_change | packet_close_window | packet_open_window | packet_window_items | packet_craft_progress_bar | packet_set_slot | packet_set_cooldown | packet_custom_payload | packet_named_sound_effect | packet_kick_disconnect | packet_entity_status | packet_explosion | packet_unload_chunk | packet_game_state_change | packet_open_horse_window | packet_keep_alive | packet_map_chunk | packet_world_event | packet_world_particles | packet_update_light | packet_login | packet_map | packet_trade_list | packet_rel_entity_move | packet_entity_move_look | packet_entity_look | packet_vehicle_move | packet_open_book | packet_open_sign_entity | packet_craft_recipe_response | packet_abilities | packet_end_combat_event | packet_enter_combat_event | packet_death_combat_event | packet_player_info | packet_position | packet_unlock_recipes | packet_entity_destroy | packet_remove_entity_effect | packet_resource_pack_send | packet_respawn | packet_entity_update_attributes | packet_camera | packet_held_item_slot | packet_update_view_position | packet_update_view_distance | packet_scoreboard_display_objective | packet_entity_metadata | packet_attach_entity | packet_entity_velocity | packet_entity_equipment | packet_experience | packet_update_health | packet_scoreboard_objective | packet_set_passengers | packet_teams | packet_scoreboard_score | packet_simulation_distance | packet_spawn_position | packet_update_time | packet_entity_sound_effect | packet_stop_sound | packet_sound_effect | packet_playerlist_header | packet_collect | packet_entity_teleport | packet_entity_head_rotation | packet_entity_effect | packet_select_advancement_tab | packet_declare_recipes | packet_tags | packet_acknowledge_player_digging | packet_sculk_vibration_signal | packet_clear_titles | packet_initialize_world_border | packet_action_bar | packet_world_border_center | packet_world_border_lerp_size | packet_world_border_size | packet_world_border_warning_delay | packet_world_border_warning_reach | packet_ping | packet_set_title_subtitle | packet_set_title_text | packet_set_title_time ;
}