...
export interface packet_debug_block_value {
    blockPos: position;
    update: DebugSubscriptionUpdate;
}

export interface packet_debug_chunk_value {
    chunkPos: packedChunkPos;
    update: DebugSubscriptionUpdate;
}

export interface packet_debug_entity_value {
    entityId: varint;
    update: DebugSubscriptionUpdate;
}

export interface packet_debug_event {
...
export interface ExplosionParticleInfo {
    particle: Particle;
    scaling: f32;
    speed: f32;
}

export interface ExplosionParticleEntry {
...
export interface packet_game_test_highlight_pos {
