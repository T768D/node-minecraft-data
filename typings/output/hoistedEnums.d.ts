...
const enum ItemConsumeEffect_type {
    "apply_effects" = 0,
    "remove_effects" = 1,
    "clear_all_effects" = 2,
    "teleport_randomly" = 3,
...
const enum DamageTypeData_scaling {
    "never" = 0,
    "when_caused_by_living_non_player" = 1,
    "always" = 2,
}

const enum DamageTypeData_effects {
    "hurt" = 0,
    "thorns" = 1,
    "drowning" = 2,
    "burning" = 3,
...
const enum DamageTypeData_deathMessageType {
    "default" = 0,
    "fall_variants" = 1,
...
const enum entityMetadataEntry_type {
    "byte" = 0,
    "int" = 1,
    "long" = 2,
    "float" = 3,
...
const enum packet_set_difficulty_newDifficulty {
    "peaceful" = 0,
    "easy" = 1,
    "normal" = 2,
    "hard" = 3,
...
const enum packet_change_gamemode_mode {
    "survival" = 0,
    "creative" = 1,
    "adventure" = 2,
    "spectator" = 3,
